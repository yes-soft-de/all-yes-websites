...
<div id="primary" class="content-area">
	<main id="main" class="site-main services-page our-work blog-main background-canvas">
...
<!--							</div>-->
                ...
                <div class="service-content-img mx-3 mx-sm-5 text-center <?php echo is_rtl() ? 'pull-left' : 'pull-right'; ?>">
                  <img class="img-fluid" src="<?php echo get_template_directory_uri() . '/images/icons/services-project-gif/' . $term->slug . '.gif' ?>" alt="category image">
...
//								'posts_per_page' => 1,
								...
								'tax_query' => array(
									array(
										'taxonomy' => 'yes_user_project_category',
										'field' => 'slug',
